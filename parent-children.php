		...
		$pcConfig = array(
			...
			'departments' => array(   
				'school' => array(   
					...
					'sortable-fields' => array(0 => '`departments`.`id`', 1 => 2, 2 => '`Faculties1`.`name`'),
					'records-per-page' => 10,
					...
					'query' => "SELECT `departments`.`id` as 'id', `departments`.`name` as 'name', IF(    CHAR_LENGTH(`Faculties1`.`name`), CONCAT_WS('',   `Faculties1`.`name`), '') as 'school' FROM `departments` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`departments`.`school` "
				)
			),
			'class_time_table' => array(   
				'school' => array(   
					...
					'sortable-fields' => array(0 => '`class_time_table`.`id`', 1 => 2, 2 => '`class_time_table`.`time_start`', 3 => '`class_time_table`.`time_end`', 4 => 5, 5 => 6, 6 => '`Faculties1`.`name`', 7 => '`departments1`.`name`', 8 => 9),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `class_time_table`.`id` as 'id', `class_time_table`.`day` as 'day', TIME_FORMAT(`class_time_table`.`time_start`, '%r') as 'time_start', TIME_FORMAT(`class_time_table`.`time_end`, '%r') as 'time_end', `class_time_table`.`unit_code` as 'unit_code', `class_time_table`.`venue` as 'venue', IF(    CHAR_LENGTH(`Faculties1`.`name`), CONCAT_WS('',   `Faculties1`.`name`), '') as 'school', IF(    CHAR_LENGTH(`departments1`.`name`), CONCAT_WS('',   `departments1`.`name`), '') as 'department', `class_time_table`.`year_of_study` as 'year_of_study' FROM `class_time_table` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`class_time_table`.`school` LEFT JOIN `departments` as departments1 ON `departments1`.`id`=`class_time_table`.`department` "
				),
				'department' => array(   
			...
			'exam_time_table' => array(   
				'school' => array(   
					...
					'sortable-fields' => array(0 => '`exam_time_table`.`id`', 1 => '`exam_time_table`.`date`', 2 => '`exam_time_table`.`time_start`', 3 => '`exam_time_table`.`time_end`', 4 => 5, 5 => 6, 6 => '`Faculties1`.`name`', 7 => '`departments1`.`name`', 8 => 9),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `exam_time_table`.`id` as 'id', if(`exam_time_table`.`date`,date_format(`exam_time_table`.`date`,'%m/%d/%Y'),'') as 'date', TIME_FORMAT(`exam_time_table`.`time_start`, '%r') as 'time_start', TIME_FORMAT(`exam_time_table`.`time_end`, '%r') as 'time_end', `exam_time_table`.`unit_code` as 'unit_code', `exam_time_table`.`venue` as 'venue', IF(    CHAR_LENGTH(`Faculties1`.`name`), CONCAT_WS('',   `Faculties1`.`name`), '') as 'school', IF(    CHAR_LENGTH(`departments1`.`name`), CONCAT_WS('',   `departments1`.`name`), '') as 'department', `exam_time_table`.`year_of_study` as 'year_of_study' FROM `exam_time_table` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`exam_time_table`.`school` LEFT JOIN `departments` as departments1 ON `departments1`.`id`=`exam_time_table`.`department` "
				),
				'department' => array(   
					'parent-table' => 'departments',
					'parent-primary-key' => 'id',
			...
			'student_details' => array(   
				'school' => array(   
					...
					'sortable-fields' => array(0 => '`student_details`.`id`', 1 => 2, 2 => '`Faculties1`.`name`', 3 => '`departments1`.`name`', 4 => 5, 5 => 6),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `student_details`.`id` as 'id', `student_details`.`full_name` as 'full_name', IF(    CHAR_LENGTH(`Faculties1`.`name`), CONCAT_WS('',   `Faculties1`.`name`), '') as 'school', IF(    CHAR_LENGTH(`departments1`.`name`), CONCAT_WS('',   `departments1`.`name`), '') as 'department', `student_details`.`year_of_study` as 'year_of_study', `student_details`.`reg_no` as 'reg_no' FROM `student_details` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`student_details`.`school` LEFT JOIN `departments` as departments1 ON `departments1`.`id`=`student_details`.`department` "
				),
				'department' => array(   
					'parent-table' => 'departments',
					'parent-primary-key' => 'id',
