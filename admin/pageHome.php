<?php
	...
	$GLOBALS['page_title'] = $Translation['membership managementUMU Time Table Managment System'];
...
<div class="page-header"><h1><?php echo $Translation['membership managementUMU Time Table Managment System']; ?></h1></div>
