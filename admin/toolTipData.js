...
// Faculties table
Faculties_addTip=["",spacer+"This option allows all members of the group to add records to the 'Faculties' table. A member who adds a record to the table becomes the 'owner' of that record."];

Faculties_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Faculties' table."];
Faculties_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Faculties' table."];
Faculties_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Faculties' table."];
Faculties_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Faculties' table."];

Faculties_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Faculties' table."];
Faculties_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Faculties' table."];
Faculties_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Faculties' table."];
Faculties_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Faculties' table, regardless of their owner."];

Faculties_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Faculties' table."];
Faculties_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Faculties' table."];
Faculties_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Faculties' table."];
Faculties_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Faculties' table."];
