<?php
	...
	$Translation['password reset invalid']="Invalid username or password. <a href=membership_passwordReset.php>Try again</a>, or go <a href=index.php>back toUMU Time Table Managment System</a>.";
	...
	$Translation['setup next 3'] = 'Go to the adminUMU Time Table Managment System where you can change many other application settings.';
