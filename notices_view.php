...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFrom = "`notices` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`notices`.`school` LEFT JOIN `departments` as departments1 ON `departments1`.`id`=`notices`.`department` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
