...
*/
	...
	$lookups = array(   
		...
		'departments' => array(   
			'school' => array(
				'parent_table' => 'Faculties',
				'parent_pk_field' => 'id',
				'parent_caption' => '`Faculties`.`name`',
				'parent_from' => '`Faculties` ',
				'filterers' => array(),
				'custom_query' => '',
		...
		'class_time_table' => array(   
			...
			'department' => array(
				...
				'parent_from' => '`departments` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`departments`.`school` ',
