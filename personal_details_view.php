...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFrom = "`personal_details` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`personal_details`.`school` LEFT JOIN `departments` as departments1 ON `departments1`.`id`=`personal_details`.`department` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
